...
export const HEROES: Hero[] = [
  ...
  { age: 19, pelage:"Pie (crins blancs ou bicolores, corps blanc avec de grandes taches noires, baies ou alezanes)", des: 'Cheval immortel doué de parole', id: 14, name: 'Arion' },
  { age: 20, pelage:"Alezan brûlé (alezan très foncé, le corps et les crins sont marrons foncés avec reflets roux)", des: "Cheval aux reflets roux", id: 15, name: 'Sleipnir' },
